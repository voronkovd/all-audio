...
export const ru: Messages = {
  ...
  mp3Tags: {
    title: "MP3-теги и обложка",
    hint: "Необязательные ID3-теги и обложка альбома для MP3. Теги считываются из исходного файла, если доступны.",
    cueHint:
      "При разделении по CUE название и номер трека заполняются автоматически. Альбом и исполнитель берутся из CUE, если не указаны здесь.",
    titleField: "Название",
    titlePlaceholder: "Название трека",
    artist: "Исполнитель",
    artistPlaceholder: "Имя исполнителя",
    album: "Альбом",
    albumPlaceholder: "Название альбома",
    albumArtist: "Исполнитель альбома",
    albumArtistPlaceholder: "Исполнитель альбома",
    year: "Год",
    ...
    chooseCover: "Выбрать изображение",
    clearCover: "Очистить",
    coverFilter: "Изображение",
  },
  status: {
    label: "Статус",
    idle: "Готово",
  ...
  errors: {
    ...
    invalidCoverPath: "Некорректный путь к обложке",
    coverNotFound: "Файл обложки не существует",
    unsupportedCoverExtension: "Обложка должна быть JPG, PNG, WebP или BMP",
  },
};
