...
export const fr: Messages = {
  ...
  mp3Tags: {
    title: "Tags MP3 et pochette",
    hint: "Tags ID3 et pochette optionnels pour le MP3. Les tags sont lus depuis le fichier source lorsque disponibles.",
    cueHint:
      "Lors d'un découpage CUE, le titre et le numéro de piste sont remplis automatiquement. L'album et l'artiste proviennent du CUE sauf si vous les modifiez ici.",
    titleField: "Titre",
    titlePlaceholder: "Titre de la piste",
    artist: "Artiste",
    artistPlaceholder: "Nom de l'artiste",
    album: "Album",
    albumPlaceholder: "Nom de l'album",
    albumArtist: "Artiste de l'album",
    albumArtistPlaceholder: "Artiste de l'album",
    year: "Année",
    ...
    trackPlaceholder: "1",
    cover: "Pochette",
    noCover: "Aucune pochette sélectionnée",
  ...
  errors: {
    ...
    invalidCoverPath: "Chemin de pochette invalide",
    coverNotFound: "Le fichier de pochette n'existe pas",
    unsupportedCoverExtension: "La pochette doit être JPG, PNG, WebP ou BMP",
  },
};
