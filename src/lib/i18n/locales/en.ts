...
export const en: Messages = {
  ...
  mp3Tags: {
    ...
    hint: "Optional ID3 tags and album artwork embedded into MP3 output. Tags are read from the source file when available.",
    cueHint:
      "When splitting by CUE, track title and number are filled automatically. Album and artist come from the CUE sheet unless you override them here.",
    titleField: "Title",
    ...
    albumArtistPlaceholder: "Album artist",
    year: "Year",
  ...
  errors: {
    ...
    invalidCoverPath: "Invalid cover image path",
    coverNotFound: "Cover image file does not exist",
    unsupportedCoverExtension: "Cover image must be JPG, PNG, WebP, or BMP",
  },
};
